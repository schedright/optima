...
alter table project_task add column guid varchar(50);

create table primavera_project (
	primavera_project_id INT NOT null AUTO_INCREMENT primary key, 
	project_id INT,
	project_guid varchar(50) UNIQUE,
