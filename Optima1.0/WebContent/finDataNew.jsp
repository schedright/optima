...
<div id="FinPeriods" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  ...
  <h3 class="ui-widget-header">Payments Collection</h3>
   ...
   <h3 class="ui-widget-header">Finances</h3>
 
   <div id="finances" class="ui-tabs ui-widget ui-widget-content ui-corner-all ui-center"  style="width:90%;">
   
   <div class="form-section">
		<div class="two-columns">
			<label for="financeNumber">Finance #</label>
			<input type="text" id="financeNumber" name="financeNumber" class=""/>
		</div>
		<div class="two-columns right">
			<label for="financeAmount">Finance Amount</label>
			<input type="text" id="financeAmount" name="financeAmount" class=""/>
		</div>	
		
		<div class="form-section">
			<div class="two-columns">
				<label for="financeDate">Finance Date</label>
				<input type="text" id="financeDate" name="financeDate" class=""/>
			</div>
		</div>
	</div>
	<div class="form-section">
	<div class="two-columns">
		...
		<tr>	
		 <td valign="top" width="50%">
   		  <div id="financeGrid" style="width:1000px; height:200px;"></div>
   		</td>
   		</tr>
   		</table>
   	</div>
